  ...
  return new Proxy(
    {},
    {
      get: (_target, prop: string) => {
        ...
        // Sem esta linha o Proxy devolveria `undefined` para `isCardAlive` e o
        // guarda de identidade do `report` (task 34e27f66) recusaria um
        // relatório legítimo — o guarda é exercitado, com os dois lados, em
