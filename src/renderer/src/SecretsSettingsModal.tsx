...
/**
 * API-keys page of the settings modal — same component that used to be
 * its own dialog. One implementation; the rail and the settings nav are
 * just two doors in. Writes go through `window.secrets` (same store the
 * ChatCard inline form uses).
 */
export function SecretsSettingsModal() {
  ...
  return (
    <div className="secrets-settings-page">
