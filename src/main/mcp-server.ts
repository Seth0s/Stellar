    ...
    server.registerTool(
      "update_task",
      {
        ...
        inputSchema: {
          ...
          // `pending`). O domínio aceito é o do modelo: pending|running|done|failed.
          // `running` é aceito e NÃO é gravado — o store o normaliza para
