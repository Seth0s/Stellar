...
const CDP_PORT = 9441;
const USER_DATA_DIR = new URL("../../.verify-tmp/smoke-chat-tools", import.meta.url).pathname;
const SCRATCH_ROOT = fileURLToPath(new URL("../../.verify-tmp/smoke-chat-tools-scratch/", import.meta.url));
